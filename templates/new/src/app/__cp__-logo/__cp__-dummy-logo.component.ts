...
@Component({
  ...
  template: `
    <svg [attr.height]="_height" [attr.width]="_width" viewBox="0 0 140 160">
      <path class="st0" d="M68.74,136.99l-0.6,0.34 M119.74,87.93v-0.8" />
      <polygon
        class="st0"
        points="137.45,77.7 136.14,117.03 68.74,156.63 68.74,136.99 119.74,107.55 119.74,87.92 "
      />
      ...
      <polygon
        class="st2"
        points="85.89,29.11 85.74,48.65 69.34,38.49 69.18,19.13 "
      />
      <path
        class="st3"
        d="M86.22,49L85.9,29.64l0.48,0.01l17.04-10.01l-0.32-0.02l-0.36,20.03l0.35-0.18l-17.34,9.81"
      />
      <polyline
        class="st3"
        points="34.52,97.74 34.58,58.65 69.18,38.68 68.96,19.14 68.56,18.81 16.89,48.66 17.55,48.88 17.52,107.55 33.89,98.1 "
      />
      <path
        class="st2"
        d="M119.74,87.13l0,20.43l0,0l-17.57-9.81l-15.83-8.84l0.09-21l33.31,20.03"
      />
      <polygon
        class="st2"
